...
<head>
    ...
    <!-- CSS-->
    <link rel="apple-touch-icon"  sizes="60x60"  href="{{ asset('corn') }}/favicons/apple-touch-icon.png" />
    <link rel="icon" type="image/png"   sizes="32x32"  href="{{ asset('corn') }}/favicons/favicon-32x32.png" />
    <link  rel="icon"   type="image/png"   sizes="16x16"  href="{{ asset('corn') }}/favicons/favicon-16x16.png"/>
...
<div class="animsition">
    ...
    <header class="header __js_fixed-header" id="header">
        <div class="header__inner">
            <!-- Logo-->
            <a href="{{ route('front.home') }}" class="header__logo logo">
                <img
    ...
    <header class="mobile-canvas __js_mobile-canvas">
        ...
        <!-- Lang switcher-->
        <ul
            class="mobile-canvas__lang-switcher lang-switcher lang-switcher--menu"
        >
            <li class="lang-switcher__item">
                <a class="lang-switcher__link lang-switcher__link--current">Az</a>
            </li>
            <li class="lang-switcher__item">
                <a class="lang-switcher__link" href="#">Ru</a>
            </li>
            <li class="lang-switcher__item">
        ...
        <nav class="mobile-canvas__nav navigation">
            <ul class="navigation__list">
                ...
                <li class="navigation__item">
                    <a class="navigation__link animsition-link" href="{{ route('front.services') }}"
                    >{{ __('menu.xidmetlerimiz') }}</a
                    >
                </li>
                <li class="navigation__item">
                ...
                <li class="navigation__item">
                    <a class="navigation__link animsition-link" href="brif.html"
                    >{{ __('menu.brif') }}</a
                    >
                </li>
                <li class="navigation__item">
        ...
        <div class="mobile-canvas__bottom">
            <a class="mobile-canvas__phone" href="tel:+72126742510"
            >+7 (212) 674-25-10</a
            >
