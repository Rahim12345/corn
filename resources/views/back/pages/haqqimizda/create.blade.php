        ...
        <div class="content m-3">
            ...
            <div class="row">
                ...
                <div class="form-group mb-3 col-md-4">
                    ...
                    <textarea name="name_az" id="name_az" cols="30" rows="4" class="form-control @error('name_az') is-invalid  @enderror">{{ old('name_az') }}</textarea>
                    @error('name_az')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3 col-md-4">
                    ...
                    <textarea name="name_en" id="name_en" cols="30" rows="4" class="form-control @error('name_en') is-invalid  @enderror">{{ old('name_en') }}</textarea>
                    @error('name_en')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3 col-md-4">
                    ...
                    <textarea name="name_ru" id="name_ru" cols="30" rows="4" class="form-control @error('name_ru') is-invalid  @enderror">{{ old('name_ru') }}</textarea>
                    @error('name_ru')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
