...
@section('content')
    <div class="page">
        ...
        <div class="content m-3">
            ...
            <form action="{{ route('blog.update',$blog->id) }}" method="POST" enctype="multipart/form-data" class="mb-5">
            @csrf
            @method('PUT')
            <div class="row mt-3">
                <img src="{{ asset('files/blogs/'.$blog->src) }}" style="width: 100px" alt="">
            </div>
            <div class="row">
                ...
                <div class="form-group mb-3 col-md-4">
                    ...
                    <input type="text" class="form-control @error('title_ru') is-invalid  @enderror" name="title_ru" id="title_ru" value="{{ old('title_ru',$blog->title_ru) }}">
                    @error('title_ru')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3 col-md-4">
                    ...
                    <textarea name="intro_az" id="intro_az" class="form-control @error('intro_az') is-invalid  @enderror" cols="30" rows="4">{{ old('intro_az',$blog->intro_az) }}</textarea>
                    @error('intro_az')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3 col-md-4">
                    ...
                    <textarea name="intro_en" id="intro_en" class="form-control @error('intro_en') is-invalid  @enderror" cols="30" rows="4">{{ old('intro_en',$blog->intro_en) }}</textarea>
                    @error('intro_en')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3 col-md-4">
                    ...
                    <textarea name="intro_ru" id="intro_ru" class="form-control @error('intro_ru') is-invalid  @enderror" cols="30" rows="4">{{ old('intro_ru',$blog->intro_ru) }}</textarea>
                    @error('intro_ru')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3 col-md-4">
                    ...
                    <textarea name="text_ru" id="text_ru" class="form-control @error('text_ru') is-invalid  @enderror" cols="30" rows="4">{{ old('text_ru',$blog->text_ru) }}</textarea>
                    @error('text_ru')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
